...
class DQN():
    ...
    def __init__(self,env):
        ...
        self.op=self.env.action_space.n
        print(self.ip,self.op)
        #self.model=self.create_model(self.ip,self.op)
    ...
    def save(self):
        self.model.save_weights("ant.model")
    def load(self):
        self.model.load_weights("ant.model")
        self.target_model.load_weights("ant.model")
...
def main():
    ...
    for _ in range(num_trials):
        cur_state = env.reset().reshape(1,dqn.ip)
        new_state=cur_state
        score = 0
        for step in range(sim_steps):
            ...
            new_state=new_state.reshape(1,dqn.ip)
